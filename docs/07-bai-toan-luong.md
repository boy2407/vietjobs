...
flowchart TD
    ...
    D{"p > 0.5?"}
    T2["<b>Tier 2 — regression</b><br/>on the 71.5% that disclose<br/>target = log1p of the midpoint"]
...
Two tiers because **28.5 % of postings say "Thoả thuận" ("negotiable")** instead
